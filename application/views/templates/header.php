    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown" id="topStudentMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="addStudentNav"><a href="<?php echo base_url('student/form') ?>">Add Student</a></li>
            <li id="addBulkStudentNav"><a href="<?php echo base_url('student/bulk') ?>">Add Bulk Student</a></li>
            <li id="manageStudentNav"><a href="<?php echo base_url('student') ?>">Manage Student</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown" id="topAttendanceMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="takeAttendNav"><a href="<?php echo base_url('attendance/take') ?>">Take Attendance</a></li>
            <li id="attenReport"><a href="<?php echo base_url('attendance') ?>">Attendance Report</a></li>
          </ul>
        </li>
        <li class="dropdown" id="topMarksheetMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="manageMarksheet"><a href="<?php echo base_url('marksheet') ?>">Manage Marksheet</a></li>
            <li id="manageMarks"><a href="<?php echo base_url('marks') ?>">Manage Marks</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown" id="topAccountMainNav">
          ...
          <ul class="dropdown-menu">
            <li id="createStudentNav"><a href="<?php echo base_url('paymentForm') ?>">Create Student Payment</a></li>
            <li id="managePayNav"><a href="<?php echo base_url('payments') ?>">Manage Payment</a></li>
            <li id="expNav"><a href="<?php echo base_url('expenses')?>">Expenses</a></li>
          </ul>
        </li>

          <li class="dropdown" id="topAccountMainNav">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-cog"></i> Users <span class="caret"></span></a>
              <ul class="dropdown-menu">
                  <li id="usersNave"><a href="<?php echo base_url('users') ?>">Manage Users</a></li>
                  <li id="RolesName"><a href="<?php echo base_url('roles') ?>">Manage Roles</a></li>
              </ul>
          </li>
      </ul>
