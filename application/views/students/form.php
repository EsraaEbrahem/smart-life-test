...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="<?php echo base_url('student/create') ?>" method="post" id="createStudentForm"
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="registerDate" name="registerDate"
                               placeholder="Register Date" autocomplete="off">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript" src="<?php echo base_url('custom/js/student-form.js') ?>"></script>
