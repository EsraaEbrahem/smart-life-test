...
class ClassesController extends MY_Controller
{
	public function __construct()
	{
        ...
        /**
         * example of methods being checked for permissions
         */
        $this->auth->only(array('index','create','fetchClassesData','update','remove'));
	...
	*/
    ...
    public function fetchClassesData()
    {
            ...
            foreach ($classData as $key => $value) {
                ...
                if($this->auth->can('update-classes')){
                    $button.='<li><a type="button" data-toggle="modal" data-target="#editClassModal" onclick="editClass('.$value['class_id'].')"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>';
                }
                if($this->auth->can('remove-classes')){
                    $button.='<li><a type="button" data-toggle="modal" data-target="#removeClassModal" onclick="removeClass('.$value['class_id'].')"> <i class="glyphicon glyphicon-trash"></i> Remove</a></li>';
                }
                    $button.='</ul>
				</div>';
