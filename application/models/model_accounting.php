...
class Model_Accounting extends CI_Model 
{
	...
	*---------------------------------------------------
	*/
	public function createIndividual($filePath)
	{
		$insert_name = array(
	...
	*/
	...
	public function totalIncome($from = null, $to= null)
	{
	...
	public function totalExpenses($from = null, $to= null)
	{
		$sql = "SELECT * FROM expenses_name";
	...
	public function totalBudget($from = null, $to = null)
	{
		$totalExpenses = $this->totalExpenses($from,$to);
		$totalIncome = $this->totalIncome($from, $to);
